                    ...
                    <form action="/dashboard/books" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="text" name="judul"
                                ...
                                placeholder="Masukkan judul" autofocus id="judul" value="{{ old('judul') }}" required>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <textarea name="penulis" class="form-control @error('penulis') is-invalid @enderror" placeholder="Masukkan nama penulis"
                                required id="floatingTextarea" style="height: 100px">{{ old('penulis') }}</textarea>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <textarea name="penerbit" class="form-control @error('penerbit') is-invalid @enderror" placeholder="Masukkan penerbit"
                                required id="floatingTextarea2" style="height: 100px">{{ old('penerbit') }}</textarea>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror"
                                placeholder="Masukkan tahun" value="{{ old('tahun') }}" required id="floatingTahun">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="number" value="{{ old('jumlah') }}" placeholder="Masukkan jumlah buku"
